...
export default class CameraLonggangEdit extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
            ...
            <Collapse >
                <Panel header="基础配置" key="1">
                    <Form {...formItemLayout24} >
                        ...
                        <Form.Item label="秘钥地址">
                            <Input value={style.keyUrl} onChange={changeDetailData.bind(this, 1, style, 'keyUrl')}/>
                        </Form.Item>
