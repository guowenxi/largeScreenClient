...
import {Form, Input, Collapse, InputNumber, Tooltip, Icon, Row, Col} from 'antd';
...
export default class ThreePyramidEdit extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
            ...
            <Form {...formItemLayout24} >
                <Collapse >
                    <Panel header="样式设置" key="1">
                        ...
                        <Form.Item label="透明度">
                            <InputNumber value={style.opacity} onChange={changeDetailData.bind(this, 2, style, 'opacity')} />
                        </Form.Item>
                        <Form.Item  label={
                            <span>
                                <Tooltip title="点击添加">
