...
import cssStyle from "./name_num_type_twentyThree.module.css";
import {getData} from "../../common/getDataUtil";
import {Motion, spring} from "react-motion";
import { getColumnNum } from "../../common/util";
import SvgBox from "./content/svgTypeOne/svgTypeOne";

export default class NameNumTypeTwentyThree extends React.Component {
    constructor(props) {
        super(props);
