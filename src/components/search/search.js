...
export default class Search extends React.Component {
    ...
    render() {
        ...
        const searchData = this.state.resultData ? this.state.resultData : {};
        if (style.contentName) {
            try {
                let SearchContent = require(`./content/${style.contentName}`).default;
                return (
                    <ComponentBox style={{ ...this.props.style}} receiveMessage={this.receiveMessage.bind(this)} reGetData={this.reGetData.bind(this)} thisData={this.props.thisData} >
                        <SearchContent style={{fontSize}} styleData={style} searchData={searchData} thisData={this.props.thisData} />
                    </ComponentBox>
                );
            } catch (e){}
        } else {
