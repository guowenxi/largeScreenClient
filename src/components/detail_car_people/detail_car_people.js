...
import cssStyle from "./detail_car_people.module.css";
...
export default class NameNumTypeThirteen extends React.Component {
    ...
    getWindowContent(style) {
        const windowPage=style.windowType
        if(windowPage&&this.state.resultData){
            const WindowBody = require(`./window/${windowPage}/${windowPage}`).default;
            return (
                <WindowBody
