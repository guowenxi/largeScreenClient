                ...
                <Scrollbars style={{height: 'calc(100% - ' + compatibleSize.titleHeight + ')',fontSize:compatibleSize.fontSize}}>
                    <div className={cssStyle.itemBox}>
                        ...
                        <table className={cssStyle.itemContent}>
                            <tbody>
                            <tr>
                                <td className={cssStyle.tdTitle}>资产类别</td>
                            ...
                            <tr>
                                <td className={cssStyle.tdTitle}>所属区域</td>
                                <td className={cssStyle.tdContent} colSpan={3}>{detail.area}</td>
                            </tr>
                            <tr>
                                <td className={cssStyle.tdTitle}>审批类型</td>
                                <td className={cssStyle.tdContent}>{detail.approvalType}</td>
                                <td className={cssStyle.tdTitle}>审批时间</td>
                                <td className={cssStyle.tdContent}>{detail.approvalTime}</td>
                            </tr>
                            <tr>
                                <td className={cssStyle.tdTitle}>入库时间</td>
                                <td className={cssStyle.tdContent}>{detail.warehousingTime}</td>
                                <td className={cssStyle.tdTitle}>预计报废日期</td>
                                <td className={cssStyle.tdContent}>{detail.estimateScrappedNum}</td>
                            </tr>
                            <tr>
                                <td className={cssStyle.tdTitle}>负责人</td>
                                <td className={cssStyle.tdContent}>{detail.dutyName}</td>
