                    ...
                    <div className={cssStyle.itemBox}>
                        ...
                        <table className={cssStyle.itemContent}>
                            <tbody>
                                ...
                                <tr>
                                    <td className={cssStyle.tdTitle}>申请依据及理由</td>
                                    <td className={cssStyle.tdContent}>{detail.comment}</td>
                                    <td className={cssStyle.tdTitle}>会议时间</td>
                                    <td className={cssStyle.tdContent}>{detail.meetingDate}</td>
                                </tr>
                                <tr>
