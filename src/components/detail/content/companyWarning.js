...
export default class CompanyWarning extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            ...
            >
                <div className={cssStyle.headBox} style={{ minHeight: compatibleSize.titleHeight }}>
                    <div className={cssStyle.head} style={{ fontSize: compatibleSize.titleSize, color: style.titleColor }}>{detail.companyName}</div>
