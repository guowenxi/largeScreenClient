                        ...
                        <table className={cssStyle.itemContent}>
                            <tbody>
                                <tr>
                                    ...
                                    <td className={cssStyle.tdTitle}>经办单位</td>
                                ...
                                <tr>
                                    ...
                                    <td className={cssStyle.tdTitle}>采购时间</td>
                                    <td className={cssStyle.tdContent}>{detail.time}</td>
                                </tr>
                                <tr>
                                    <td className={cssStyle.tdTitle}>采购方式</td>
                                    <td className={cssStyle.tdContent}>{detail.mode}</td>
                                    <td className={cssStyle.tdTitle}>预算金额</td>
                                    <td className={cssStyle.tdContent}>{detail.money}</td>
                                </tr>
                                <tr>
                                    <td className={cssStyle.tdTitle}>合同金额</td>
                                    <td className={cssStyle.tdContent}>{detail.contractMoney}</td>
                                    <td className={cssStyle.tdTitle}>中标方</td>
                                    <td className={cssStyle.tdContent}>{detail.bidName}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
