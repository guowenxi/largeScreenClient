...
import cssStyle from "./tankListThree.module.css";

import tankBg from "../images/tankThree.png";
...
export default class TankListThree extends React.Component {
    ...
    render() {
        ...
        const { name,scaleList,tankList,tankPumpList,carPumpList } = detail;
        return (
            <div style={this.props.style} className={`${cssStyle.box}`} >
                {loading ? (
                    ...
                    <React.Fragment>
                        ...
                        <div className={cssStyle.scaleListBox}>
                            ...
                            {tankList && tankList.map((item,index)=>{
                                ...
                                return (
                                    <div key={index} className={cssStyle.tankItemBox}>
                                        ...
                                        <div className={cssStyle.otherDataBox}>
                                        ...
                                        <div className={cssStyle.subData}>{item.subNum}</div>
                                    </div>
                                );
                            })}
                        </div>
