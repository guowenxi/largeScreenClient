                    ...
                    <div className={cssStyle.itemBox}>
                        ...
                        <table className={cssStyle.itemContent}>
                            <tbody>
                                ...
                                <tr>
                                    <td className={cssStyle.tdTitle}>项目起止时间</td>
                                ...
                                <tr>
                                    <td className={cssStyle.tdTitle}>项目属性</td>
                                    <td className={cssStyle.tdContent}>{detail.type}</td>
                                    <td className={cssStyle.tdTitle}>资金来源</td>
                                    <td className={cssStyle.tdContent}>{detail.origin}</td>
                                </tr>
                                <tr>
