...
import cssStyle from "./equipmentDesignateNew.module.css";
...
export default class EquipmentDesignateNew extends React.Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div style={{ ...this.props.style, }} className={cssStyle.container}>
                <div className={cssStyle.top}>
                    <span className={cssStyle.title}>移动可视设备指派</span>
