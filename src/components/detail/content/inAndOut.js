        ...
        return (
            ...
            >
                <div className={cssStyle.headBox} style={{height:compatibleSize.titleHeight}}>
                    <div className={cssStyle.head} style={{fontSize:compatibleSize.titleSize,color: style.titleColor,width:style.titleWidth}}>{detail.goodName}</div>
                </div>
                ...
                <Scrollbars style={{height: 'calc(100% - ' + compatibleSize.titleHeight + ')',fontSize:compatibleSize.fontSize}}>
                    <div className={cssStyle.itemBox}>
                        ...
                        <table className={cssStyle.itemContent}>
                            ...
                            <tr>
                                <td className={cssStyle.tdTitle}>出入时间</td>
                                <td className={cssStyle.tdContent}>{detail.time}</td>
                                <td className={cssStyle.tdTitle}>出入类型</td>
                            ...
                            <tr>
                                ...
                                <td className={cssStyle.tdTitle}>楼号选择</td>
                                <td className={cssStyle.tdContent}>{detail.build}</td>
                            </tr>
                            <tr>
                                <td className={cssStyle.tdTitle}>申请事由</td>
                                <td className={cssStyle.tdContent} colSpan={3}>{detail.reason}</td>
                            </tr>
                            <tr>
                                <td className={cssStyle.tdTitle}>物品图片</td>
                                <td className={cssStyle.tdContent} colSpan={3}>
                                    {detail.pic ? <img alt='' className={cssStyle.detailImg} src={detail.pic} /> : '无'}
                                </td>
                            </tr>
                            <tr>
                                <td className={cssStyle.tdTitle}>出入车辆牌照</td>
                                <td className={cssStyle.tdContent} colSpan={3}>{detail.license}</td>
                            </tr>
                            <tr>
