...
import { Input, Upload, Radio, Modal, Icon} from "antd";
            ...
            <div style={this.props.style} className={cssStyle.box}>
                <div className={`${cssStyle.contentOne} antdSelectThemeOne`}>
                    <Scrollbars>
                        ...
                        <div className={cssStyle.row}>
                            <div className={cssStyle.title}><span className={cssStyle.red}>*</span>报告名称 王曼</div>
                        </div>
                        <div className={cssStyle.row2}>
                            <div className={cssStyle.title}><span className={cssStyle.red}>*</span>报告类型</div>
                            <Radio.Group className={cssStyle.editRow} >
                              <Radio value={1}><span className={cssStyle.white}>日常管控</span></Radio>
                              <Radio value={2}><span className={cssStyle.white}>一日三次面</span></Radio>
                              <Radio value={3}><span className={cssStyle.white}>零报告</span></Radio>
                            </Radio.Group>
                        </div>
                        <div className={cssStyle.row} style={{height:'auto'}}>
                            <div className={cssStyle.title}><span className={cssStyle.red}>*</span>报告内容</div>
