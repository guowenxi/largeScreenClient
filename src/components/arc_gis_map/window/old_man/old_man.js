...
export default class OldMan extends React.Component {
    constructor(props) {
        super(props);
            ...
            <div ref={this.refDom} className={`${cssStyle.box} ${cssStyle.themeOneBox}`} style={this.props.style}>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td className={cssStyle.itemBox}>
                            <div className={cssStyle.title}>电力消耗指数</div>
                            <div className={cssStyle.content} style={{color:"red"}}>{attributes.electric}</div>
                        </td>
                    </tr>
                    <tr>
