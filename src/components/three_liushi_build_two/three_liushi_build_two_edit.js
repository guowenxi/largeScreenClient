...
export default class ThreeLiushiBuildTwoEdit extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
        ...
        return (
            <Form {...formItemLayout24} >
                <Collapse >
                    ...
                    <Panel header="建筑点击交互" key="5">
                        {this.getInteractEdit(style.buildClickInteract)}
                        <Form.Item label="">
                            <Button type="dashed" onClick={addListItem.bind(this, style, 'buildClickInteract', {})}>
                                <Icon type="plus" /> 添加交互内容
                            </Button>
                        </Form.Item>
                    </Panel>
                    <Panel header="图标点击交互" key="6">
                    ...
                    <Panel header="建筑移动结束交互" key="7">
                        {this.getInteractEdit(style.moveEndInteract)}
                        <Form.Item label="">
                            <Button type="dashed" onClick={addListItem.bind(this, style, 'moveEndInteract', {})}>
                                <Icon type="plus" /> 添加交互内容
                            </Button>
                        </Form.Item>
                    </Panel>
