                ...
                {width && height ? (
                    <svg x="0" y="0" viewBox={`0 0 ${width} ${height}`} style={{ width: '100%', height: '100%' }}>
                        <g>
                            ...
                            <polyline points={`7.6,18.9 33.6,1 ${width},1 `} className={cssStyle.polyline} style={{ stroke: `url(#SVGID_1_${this.id})` }} />
                            ...
                            <path d={`M7.6,16.1c1.6,0,2.8,1.3,2.8,2.9s-1.3,2.9-2.8,2.9c-1.6,0-2.8-1.3-2.8-2.9C4.8,17.4,6,16.1,7.6,16.1   z`} className={cssStyle.path2} />
                        </g>
                    </svg>
                ) : ''}
            </div>
